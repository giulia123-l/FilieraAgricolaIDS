...
public class CreateMarketplacePermission implements PermissionStrategy {
    @Override
    public void check(Utente u) {
        ...
        if (r != Ruolo.DISTRIBUTORE && r != Ruolo.GESTORE) throw new IllegalStateException("Solo DISTRIBUTORE o GESTORE può creare marketplace");
    }
}
