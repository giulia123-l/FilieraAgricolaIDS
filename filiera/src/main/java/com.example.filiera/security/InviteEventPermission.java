...
public class InviteEventPermission implements PermissionStrategy {
    @Override
    public void check(Utente u) {
        ...
        if (u.getRuoloAssegnato() != Ruolo.ANIMATORE) throw new IllegalStateException("Solo ANIMATORE può invitare agli eventi");
    }
}
